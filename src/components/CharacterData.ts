...
export const CHARACTERS: CharacterDef[] = [
  // ── 1. SIEGFRIED — Holy Knight ──
  {
    ...
    color: '#8B0000', skin: '#e8b878', hair: '#2a1a0a',
    ...
    koWinnerLines: [
      "By the holy blade you are vanquished!",
      "Your skull makes a fine trophy!",
      "Kneel before the holy knight!",
      "Another soul purified by my blade!",
      "The light has judged you unworthy!",
      "I've slain dragons tougher than you!",
    ],
    koLoserLines: [
      "The light fades from my eyes...",
      "I have failed my sacred oath...",
      "This cannot be I am SIEGFRIED!",
      "My armor shattered like glass...",
      "Tell the kingdom I fought with honor...",
      "Even holy knights bleed...",
    ],
    specialLines: [
      "BURN IN HELL!",
      "TASTE THE SKULL'S FURY!",
      "FEEL THE SACRED FLAMES!",
      "YOUR SOUL IS FORFEIT!",
    ],
    tauntLines: [
      "Your technique is laughable!",
      "I've trained with gods you mortal!",
      "Come face divine judgment!",
      "You dare challenge a holy knight?!",
    ],
  },
  ...
  // ── 2. NIGHTMARE — Dark Knight ──
  {
    ...
    color: '#1a1a4a', skin: '#c4956a', hair: '#111',
    ...
    koWinnerLines: [
      ...
      "I am the shadow that devours!",
      "Pathetic mortal scum!",
      "The void welcomes your corpse!",
      "Tremble before true darkness!",
    ],
    koLoserLines: [
      "The darkness retreats for now...",
      "Impossible no one defeats NIGHTMARE!",
      "I will return from the shadows...",
      "This is not the end of darkness...",
      "My dark power wanes...",
      "The void rejects my failure...",
    ],
    specialLines: [
      "DRAGON DESTROY THEM!",
      "UNLEASH THE BEAST!",
  ...
  // ── 3. INFERNO — Fire Demon ──
  {
    ...
    color: '#cc3300', skin: '#8b3a2a', hair: '#ff4400',
    ...
    koWinnerLines: [
      ...
      "I am the fire that never dies!",
      "Reduced to cinders!",
      "The inferno spares no one!",
      "Burn baby BURN!",
    ],
    koLoserLines: [
      "My flames extinguished?!",
      "Even hellfire can be quenched...",
      "The embers will rise again!",
      "Impossible I AM fire itself!",
    ...
    specialLines: [
      ...
      "HEAVEN AND HELL RAIN DOWN!",
    ],
    tauntLines: [
      "Getting warm yet?!",
      "I'll melt that smug face off!",
      "Play with fire get burned!",
      "Your flesh will sizzle nicely!",
    ],
  },
  ...
  // ── 4. FROST — Ice Assassin ──
  {
    ...
    color: '#1a4a6a', skin: '#d4cee8', hair: '#e0e8ff',
    ...
    koWinnerLines: [
      "Cold as death precise as ice.",
      "You shattered like frozen glass!",
      "Winter claims another victim.",
      "Freeze then break.",
      "Your blood runs cold... permanently.",
      "Ice is patient. Ice always wins.",
    ],
    koLoserLines: [
      "The ice... it melts...",
      "Impossible I don't feel warmth...",
      "A crack in the glacier...",
      "The cold cannot protect me...",
      "Spring comes for everyone...",
      "My frozen heart shatters...",
    ],
    specialLines: [
      "FREEZE!",
      "ABSOLUTE ZERO!",
    ...
    tauntLines: [
      "You're already dead just frozen.",
      "Cold blooded is a compliment.",
      "Chill out permanently.",
      "Ice to meet your end.",
    ],
  },
  ...
  // ── 5. VIPER — Poison Ninja ──
  {
    ...
    color: '#2a5a2a', skin: '#b8a878', hair: '#1a3a1a',
    ...
    koWinnerLines: [
      ...
      "Poison is the art of patience!",
      "One drop is all it takes!",
      "Your organs are dissolving!",
      "Death by a thousand toxins!",
    ],
    koLoserLines: [
      "My own venom betrays me...",
      "Even serpents can be crushed...",
      "The antidote I need the antidote!",
      "A ninja should never be caught...",
      "The poison couldn't save me...",
      "I've been... outvenomed...",
    ],
    specialLines: [
      "BREATHE DEEP!",
      "TOXIC CLOUD DEPLOY!",
    ...
    tauntLines: [
      "Already poisoned you didn't notice.",
      "My blade drips with your death.",
      "Silent and deadly like gas.",
      "You smell that? It's your end.",
    ],
  },
  ...
  // ── 6. TITAN — War Juggernaut ──
  {
    ...
    color: '#5a4a2a', skin: '#6a4a2a', hair: '#000',
    ...
    koWinnerLines: [
      ...
      "I crush mountains you are less!",
    ...
    koLoserLines: [
      ...
      "The bigger they are...",
      "The earth weeps for me...",
    ],
    specialLines: [
      "FEEL THE EARTH SHAKE!",
      "SEISMIC DEVASTATION!",
      "THE GROUND IS MY WEAPON!",
      "EARTHQUAKE!",
    ],
    tauntLines: [
      "I bench press boulders for fun!",
      "You're an ant to me!",
      "Titan doesn't block Titan TANKS!",
  ...
  // ── 7. SHADE — Shadow Wraith ──
  {
    ...
    color: '#2a1a3a', skin: '#9a8a9a', hair: '#1a0a2a',
    ...
    koWinnerLines: [
      "You fought my shadow and lost.",
      "I was never really there.",
      "The darkness takes another.",
      "Phantom blade claims you.",
      "You cannot kill what isn't real.",
      "Which one was the real me?",
    ],
    koLoserLines: [
      "The shadows dissipate...",
      "Even phantoms can be pierced...",
      "I fade into nothing...",
      "The shadow realm calls me back...",
      "My form was too unstable...",
      "Can you kill a shadow twice...",
    ],
    specialLines: [
      "SHADOW CLONE ATTACK!",
      "PHANTOM BARRAGE!",
    ...
    tauntLines: [
      ...
      "I exist between the shadows.",
      "Catch me if you can ghost boy.",
      "Boo.",
    ],
  },
  ...
  // ── 8. VOLT — Lightning Fighter ──
  {
    ...
    color: '#4a4a1a', skin: '#e8d8a8', hair: '#eee060',
    ...
    koWinnerLines: [
      ...
      "Fully CHARGED baby!",
      "That's a million volts of pain!",
  ...
  // ── 9. CRIMSON — Blood Berserker ──
  {
    ...
    color: '#5a0a0a', skin: '#c8a888', hair: '#8a1a1a',
    ...
    koLoserLines: [
      "My own blood spills...",
      "The frenzy consumes me...",
      "I drown in crimson...",
      "The bloodlust wasn't enough...",
      "Even berserkers fall...",
      "My blood rage fades...",
    ],
    specialLines: [
    ...
    tauntLines: [
      ...
      "Bleeding yet? You will be!",
      "My sword thirsts!",
      "Pain is my breakfast!",
    ],
  },
  ...
  // ── 10. GOLEM — Stone Giant ──
  {
    ...
    color: '#5a5a5a', skin: '#8a8a7a', hair: '#4a4a3a',
    ...
    koWinnerLines: [
      "GOLEM CRUSH PUNY HUMAN!",
      "Stone always wins!",
      "You hit like a pebble!",
      "Golem is unbreakable!",
      "Crushed to dust!",
      "Rock beats everything!",
    ],
    koLoserLines: [
      "Golem crumble...",
      "The stones fall apart...",
      "Golem not understand losing...",
      "Rock can break?!",
      "Golem needs glue...",
      "The mountain erodes...",
    ],
    specialLines: [
      "GOLEM THROW BIG ROCK!",
      "BOULDER SMASH!",
      "CATCH THIS!",
      "STONE RAIN!",
    ],
    tauntLines: [
      "Golem bored. Fight harder.",
      "You tickle Golem.",
      "Golem stand here all day.",
      "Puny. Very puny.",
    ],
  },
  ...
  // ── 11. REAPER — Death Incarnate ──
  {
    ...
    color: '#1a1a1a', skin: '#b8b0a8', hair: '#e8e0d8',
    ...
    koWinnerLines: [
      ...
      "Death comes for all.",
      "Another name in my ledger.",
      "The harvest is bountiful.",
      "You were always going to die here.",
      "I am inevitable.",
    ],
    koLoserLines: [
      "Death cannot die... can it?",
      "The scythe falls from my grip...",
      "Even reapers can be reaped...",
      "My hourglass empties...",
      "The afterlife rejects me...",
      "I cheat death but not today...",
    ],
    specialLines: [
      "YOUR SOUL IS MINE!",
      "HARVEST TIME!",
    ...
    tauntLines: [
      "I've seen your death already.",
      "Tick tock your time runs out.",
      "Death is patient.",
      "Your expiration date is today.",
    ],
  },
  ...
  // ── 12. PHOENIX — Flame Spirit ──
  {
    ...
    color: '#aa5500', skin: '#e8c888', hair: '#ff6600',
    ...
    koWinnerLines: [
      ...
      "Reborn through your defeat!",
      "My flames are eternal!",
      "Ash to ash dust to dust!",
      "The fire of rebirth consumes you!",
    ],
    koLoserLines: [
      "I will rise again...",
      "The flame flickers but never dies...",
      "From these ashes I shall return...",
      "A temporary setback...",
      "Even the phoenix must rest...",
      "The cycle continues...",
    ],
    specialLines: [
      "FIRE TORNADO!",
    ...
    tauntLines: [
      "You can't kill what rises again!",
      "My flames dance with joy!",
      "Warm enough for you?!",
