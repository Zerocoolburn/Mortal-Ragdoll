...
export const BOSSES: BossDef[] = [
  // ── LEVEL 1: THE DESERTER ──
  {
    ...
    armorType: 'medium', helmetType: 'bandana',
    capeColor: '#3a3a2a', glowColor: null, scarCount: 1,
  ...
  // ── LEVEL 5: THE TWINS ──
  {
    ...
    color: '#0a0a1a', color2: '#2244aa', skin: '#4a4a6a', hair: '#000011',
    weaponKey: 'longsword', specialType: 'shadowClone',
    ...
    bodyScale: 0.95, headScale: 0.9,
    armorType: 'light', helmetType: 'mask',
    capeColor: '#0a0a2a', glowColor: '#0022aa', scarCount: 0,
    eyeColor: '#0044ff', eyeGlow: true, tattooColor: '#001188', trailColor: '#0022aa',
    storyIntro: 'The chamber goes dark. When light returns, Umbra stands before you — a being made of living shadow.',
  ...
  // ── LEVEL 6: THE BERSERKER KING ──
  {
    ...
    storyIntro: 'The mountain trembles. Grendel, the Berserker King, descends from his throne of skulls. His axes are as tall as you.',
  ...
  // ── LEVEL 7: THE FROST EMPRESS ──
  {
    level: 7, hpMultiplier: 1.3, dmgMultiplier: 1.2, speedMultiplier: 1.1,
    id: 'boss_empress', name: 'GLACIRA', title: 'Frost Empress',
    color: '#1a3a5a', color2: '#88ccff', skin: '#d4d8ee', hair: '#aaccff',
    weaponKey: 'spear', specialType: 'iceBlast',
    specialName: 'ETERNAL WINTER', specialColor: '#44ccff', specialGlow: '#88eeff',
    aiStyles: ['tactician', 'guardian', 'assassin'], voicePitch: 1.15, voiceRate: 1.0,
    bodyScale: 1.0, headScale: 1.0,
    armorType: 'robe', helmetType: 'crown',
    capeColor: '#2a4a6a', glowColor: '#4488ff', scarCount: 0,
    eyeColor: '#88eeff', eyeGlow: true, tattooColor: '#4488cc', trailColor: '#2266aa',
    storyIntro: 'The throne room is a frozen wasteland. Glacira rises from her ice throne, frost crystallizing the air around her.',
  ...
  // ── LEVEL 8: THE INFERNAL LORD ──
  {
    level: 8, hpMultiplier: 1.5, dmgMultiplier: 1.3, speedMultiplier: 1.0,
    id: 'boss_infernal', name: 'MOLOCH', title: 'Infernal Lord',
    color: '#6a1a00', color2: '#ff4400', skin: '#4a1a0a', hair: '#ff2200',
    weaponKey: 'greatsword', specialType: 'meteorRain',
    specialName: 'HELLSTORM', specialColor: '#ff4400', specialGlow: '#ff8800',
    aiStyles: ['berserker', 'wild', 'juggernaut'], voicePitch: 0.5, voiceRate: 0.75,
    bodyScale: 1.35, headScale: 1.1,
    armorType: 'heavy', helmetType: 'flame',
    capeColor: '#440000', glowColor: '#ff2200', scarCount: 0,
    eyeColor: '#ffff00', eyeGlow: true, tattooColor: '#ff4400', trailColor: '#ff2200',
    storyIntro: 'Lava erupts from cracks in the floor. Moloch steps through the flames — a demon lord forged in hellfire itself.',
  ...
  // ── LEVEL 9: THE UNDEAD KING ──
  {
    level: 9, hpMultiplier: 1.5, dmgMultiplier: 1.3, speedMultiplier: 1.05,
    id: 'boss_undead', name: 'REVENANT', title: 'The Undead King',
    color: '#1a2a1a', color2: '#44ff44', skin: '#6a7a6a', hair: '#2a3a2a',
    weaponKey: 'spear', specialType: 'soulHarvest',
    specialName: 'DEATH\'S HARVEST', specialColor: '#44ff44', specialGlow: '#88ff88',
    aiStyles: ['tactician', 'assassin', 'guardian'], voicePitch: 0.6, voiceRate: 0.82,
    bodyScale: 1.1, headScale: 0.95,
    armorType: 'heavy', helmetType: 'skull',
    capeColor: '#0a1a0a', glowColor: '#22aa22', scarCount: 0,
    eyeColor: '#44ff44', eyeGlow: true, tattooColor: null, trailColor: '#22aa22',
    storyIntro: 'The crypt opens. Revenant, dead a thousand years, sits upright on his tomb. His eyes glow with stolen souls.',
  ...
  // ── LEVEL 10: THE STORM TITAN ──
  {
    level: 10, hpMultiplier: 1.7, dmgMultiplier: 1.4, speedMultiplier: 1.0,
    id: 'boss_titan', name: 'THORAXIS', title: 'Storm Titan',
    color: '#3a3a5a', color2: '#ffff00', skin: '#8a8aaa', hair: '#ccccff',
    weaponKey: 'axe', specialType: 'lightningStorm',
    specialName: 'DIVINE STORM', specialColor: '#ffff00', specialGlow: '#ffffaa',
    aiStyles: ['juggernaut', 'berserker', 'wild'], voicePitch: 0.45, voiceRate: 0.72,
    bodyScale: 1.4, headScale: 1.2,
    armorType: 'heavy', helmetType: 'spikes',
    capeColor: '#2a2a4a', glowColor: '#ffff00', scarCount: 2,
    eyeColor: '#ffff00', eyeGlow: true, tattooColor: '#aaaa00', trailColor: '#ffff00',
    storyIntro: 'Thunder splits the sky. Thoraxis descends from the clouds, a colossus of stone and lightning. The ground cracks beneath his feet.',
  ...
  // ── LEVEL 11: THE VOID DRAGON ──
  {
    level: 11, hpMultiplier: 1.8, dmgMultiplier: 1.5, speedMultiplier: 1.15,
    id: 'boss_dragon', name: 'VOIDMAW', title: 'The Void Dragon',
    color: '#0a0a2a', color2: '#4400ff', skin: '#2a1a4a', hair: '#0000aa',
    weaponKey: 'greatsword', specialType: 'dragonStrike',
    specialName: 'VOID ANNIHILATION', specialColor: '#4400ff', specialGlow: '#8844ff',
    aiStyles: ['wild', 'berserker', 'acrobat'], voicePitch: 0.4, voiceRate: 0.7,
    bodyScale: 1.4, headScale: 1.15,
    armorType: 'none', helmetType: 'horns',
    capeColor: '#0a0a2a', glowColor: '#4400ff', scarCount: 0,
    eyeColor: '#8844ff', eyeGlow: true, tattooColor: '#4400aa', trailColor: '#2200aa',
    storyIntro: 'Reality tears open. Voidmaw, a being from beyond the stars, slithers through the rift. Its form is barely humanoid.',
  ...
  // ── LEVEL 12: DEATH GOD (FINAL BOSS) ──
  {
    level: 12, hpMultiplier: 2.0, dmgMultiplier: 1.6, speedMultiplier: 1.2,
    id: 'boss_deathgod', name: 'THANATOS', title: 'God of Death',
    color: '#0a0a0a', color2: '#ff0000', skin: '#3a3a3a', hair: '#110000',
    weaponKey: 'greatsword', specialType: 'soulHarvest',
    specialName: 'ABSOLUTE DEATH', specialColor: '#ff0000', specialGlow: '#ff4444',
    aiStyles: ['berserker', 'tactician', 'wild', 'juggernaut'], voicePitch: 0.35, voiceRate: 0.68,
    bodyScale: 1.4, headScale: 1.2,
    armorType: 'heavy', helmetType: 'skull',
    capeColor: '#0a0000', glowColor: '#ff0000', scarCount: 3,
    eyeColor: '#ff0000', eyeGlow: true, tattooColor: '#aa0000', trailColor: '#ff0000',
    storyIntro: 'The arena falls silent. Reality itself trembles. THANATOS, the God of Death, manifests — the ultimate being. "No mortal has ever stood where you stand. None have survived."',
