...
export const CHARACTERS: CharacterDef[] = [
  ...
  // ── 2. NIGHTMARE — Dark Knight ──
  {
    ...
    capeColor: '#1a0a3a', glowColor: '#40f',
    scarCount: 2, eyeColor: '#f00', eyeGlow: true,
    tattooColor: '#40a', trailColor: '#408',
  ...
  // ── 3. INFERNO — Fire Demon ──
  {
    ...
    capeColor: null, glowColor: '#f40',
    scarCount: 0, eyeColor: '#ff0', eyeGlow: true,
    tattooColor: '#f60', trailColor: '#f40',
  ...
  // ── 4. FROST — Ice Assassin ──
  {
    ...
    capeColor: '#2a5a8a', glowColor: '#08f',
    scarCount: 0, eyeColor: '#0ff', eyeGlow: true,
    tattooColor: '#4af', trailColor: '#08f',
  ...
  // ── 5. VIPER — Poison Ninja ──
  {
    ...
    scarCount: 1, eyeColor: '#0f0', eyeGlow: false,
    tattooColor: '#0a0', trailColor: '#0804',
  ...
  // ── 6. TITAN — War Juggernaut ──
  {
    ...
    capeColor: null, glowColor: null,
    scarCount: 3, eyeColor: '#fa0', eyeGlow: false,
    tattooColor: '#840', trailColor: null,
